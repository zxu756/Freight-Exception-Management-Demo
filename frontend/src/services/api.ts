...
export const worldAPI = {
  ...
  getUsers: async () => (await api.get('/world/users')).data,
  getNetworkEvents: async () => (await api.get('/world/network-events')).data,
  batchNotifyEvent: async (eventId: number, by: string) => (await api.post(`/world/network-events/${eventId}/notify`, { by })).data,
